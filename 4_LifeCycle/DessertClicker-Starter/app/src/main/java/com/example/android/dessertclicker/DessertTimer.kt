...
//adding this constructor and implementing this interface to a class will enable it to better manage the lifecycle
class DessertTimer (lifecycle: Lifecycle) : LifecycleObserver {
    ...
    //This will connect the lifecycle object passed in from the owner (the activity) to this class (the observer)
    init {
        lifecycle.addObserver(this)
    }

    //adding the observer with this annotation
